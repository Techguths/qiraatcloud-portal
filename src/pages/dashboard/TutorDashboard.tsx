...
const TutorDashboard = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "overview": return <TutorOverview />;
        ...
        <div className="p-4 mx-3 mt-4 rounded-xl bg-secondary/50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-gold flex items-center justify-center">
              <span className="text-sm font-bold text-accent-foreground">BA</span>
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-foreground truncate">Ustadh Bilal Ahmad</p>
              <p className="text-xs text-muted-foreground truncate">Hifz & Tajweed Tutor</p>
            </div>
          </div>
        </div>
        ...
        <header className="sticky top-0 z-30 bg-background/90 backdrop-blur-lg border-b border-border px-4 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="font-display text-lg font-bold text-foreground">Tutor Dashboard</h1>
