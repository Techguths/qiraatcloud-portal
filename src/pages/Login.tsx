...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (loginEmail.toLowerCase().includes("platform-admin") || loginEmail.toLowerCase().includes("superadmin")) {
      navigate("/dashboard/admin");
    } else if (loginEmail.toLowerCase().includes("academy-admin")) {
      navigate("/dashboard/academy-admin");
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Welcome to QiraatCloud. Let's get started!",
    });
          ...
          {activeTab === "signup" && (
            <form onSubmit={handleSignup} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label htmlFor="signup-confirm" className="block text-sm font-medium text-foreground mb-2">
                    Confirm Password
                  </label>
                  <Input
                    id="signup-confirm"
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-hero items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md text-center">
          <h2 className="font-display text-3xl font-bold text-primary-foreground mb-6">
            Empower Your Qur'an Teaching Journey
          </h2>
          <p className="text-primary-foreground/80 text-lg mb-8">
            Join hundreds of Qur'an educators who trust QiraatCloud to manage their academies, 
            track student progress, and grow their impact.
          </p>
          
          {/* Testimonial */}
          <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-2xl p-6 border border-primary-foreground/20">
            <p className="text-primary-foreground italic mb-4">
              "QiraatCloud made it possible to manage 200+ students with just 3 admin staff. 
              It's a game-changer for Islamic education."
            </p>
            <div className="flex items-center justify-center gap-3">
              <div className="w-10 h-10 bg-accent rounded-full flex items-center justify-center">
                <span className="font-semibold text-accent-foreground">A</span>
              </div>
              <div className="text-left">
                <div className="font-medium text-primary-foreground">Sheikh Abdullah</div>
                <div className="text-sm text-primary-foreground/70">Global Hifz Institute</div>
              </div>
            </div>
          </div>
        </div>
